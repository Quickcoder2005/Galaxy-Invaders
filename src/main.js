...
class Game{
	...
	load(){
		this.urls = {
			level1Img: "assets/maps/level1.png",
			level2Img: "assets/maps/level2.png",
			level3Img: "assets/maps/level3.png",
			bg1Img: "assets/backgrounds/background1.png",
			bg2Img: "assets/backgrounds/background2.png",
			bg3Img: "assets/backgrounds/background3.png",
			playerImg: "assets/sprites/player.png",
			slimeImg: "assets/sprites/slime.png",
			eaterImg: "assets/sprites/eater.png",
			ghostImg: "assets/sprites/ghost.png",
			portalImg: "assets/sprites/portal.png",
			boltImg: "assets/images/bolt.png",
			mushroomImg: "assets/images/mushroom.png",
			diamondImg: "assets/images/diamond.png",
			lives1Img: "assets/images/lives1.png",
			lives2Img: "assets/images/lives2.png",
			lives3Img: "assets/images/lives3.png"
		};
		...
		for (let i in this.urls){
			fetch(this.urls[i]).then((response) => response.blob()).then(data => { 
			    ...
			    if (Object.keys(this.assets).length === this.urlLen){
					fetch("assets/maps/levels.json").then((response) => response.json()).then((data) => {
						this.data = data;
